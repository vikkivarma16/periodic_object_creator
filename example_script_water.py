...
basis = [[0.0000000, 0.000000,  0.00000, "O"], [0.8164904, 0.5773590, 0.00000, "H"], [-0.8164904, 0.5773590, 0.00000, "H"]]
...
build_topology(water_lattic, bond_length, tolerance, id_index=4,
                   coord_indices=(0, 1, 2), export_base="topology",
                   many_body=True, id_body_index=5)
